...
describe GoalsController do
  ...
  describe "GET show" do
    it "assigns the requested goal as @goal" do
      goal = Goal.create! valid_attributes
      get :show, {:id => goal.to_param}, valid_session, :format => :json
  ...
  describe "GET edit" do
    it "assigns the requested goal as @goal" do
      goal = Goal.create! valid_attributes
      get :edit, {:id => goal.to_param}, valid_session, :format => :json
      assigns(:goal).should eq(goal)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Goal" do
        expect {
          post :create, {:goal => valid_attributes}, valid_session, :format => :json
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved goal as @goal" do
        ...
        post :create, {:goal => {}}, valid_session, :format => :json
        assigns(:goal).should be_a_new(Goal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested goal" do
        ...
        put :update, {:id => goal.to_param, :goal => {'these' => 'params'}}, valid_session, :format => :json
      end

      it "assigns the requested goal as @goal" do
        goal = Goal.create! valid_attributes
        put :update, {:id => goal.to_param, :goal => valid_attributes}, valid_session, :format => :json
        assigns(:goal).should eq(goal)
      end
    ...
    describe "with invalid params" do
      it "assigns the goal as @goal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Goal.any_instance.stub(:save).and_return(false)
        put :update, {:id => goal.to_param, :goal => {}}, valid_session, :format => :json
        assigns(:goal).should eq(goal)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested goal" do
      goal = Goal.create! valid_attributes
      expect {
        delete :destroy, {:id => goal.to_param}, valid_session, :format => :json
      }.to change(Goal, :count).by(-1)
    end
