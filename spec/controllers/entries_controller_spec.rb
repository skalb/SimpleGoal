...
describe EntriesController do
  ...
  describe "GET show" do
    it "assigns the requested entry as @entry" do
      entry = Entry.create! valid_attributes
      get :show, {:id => entry.to_param}, valid_session, :format => :json
  ...
  describe "GET edit" do
    it "assigns the requested entry as @entry" do
      entry = Entry.create! valid_attributes
      get :edit, {:id => entry.to_param}, valid_session, :format => :json
      assigns(:entry).should eq(entry)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Entry" do
        expect {
          post :create, {:entry => valid_attributes}, valid_session, :format => :json
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved entry as @entry" do
        ...
        post :create, {:entry => {}}, valid_session, :format => :json
        assigns(:entry).should be_a_new(Entry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested entry" do
        ...
        put :update, {:id => entry.to_param, :entry => {'these' => 'params'}}, valid_session, :format => :json
      end

      it "assigns the requested entry as @entry" do
        entry = Entry.create! valid_attributes
        put :update, {:id => entry.to_param, :entry => valid_attributes}, valid_session, :format => :json
        assigns(:entry).should eq(entry)
      end
    ...
    describe "with invalid params" do
      it "assigns the entry as @entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Entry.any_instance.stub(:save).and_return(false)
        put :update, {:id => entry.to_param, :entry => {}}, valid_session, :format => :json
        assigns(:entry).should eq(entry)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested entry" do
      entry = Entry.create! valid_attributes
      expect {
        delete :destroy, {:id => entry.to_param}, valid_session, :format => :json
      }.to change(Entry, :count).by(-1)
    end
